"""
Objective: Deletion at the end of singly linked list.
"""
...
class DeleteAtEnd:
    """
    A class representing a singly linked list with an operation to delete a node at the end.
    ...
    def __init__(self):
        """
        Initializes a new instance of the DeleteAtEnd class.
        """
        self.head = None
